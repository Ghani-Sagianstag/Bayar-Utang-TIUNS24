...
def show_cover(window):
    ...
    try:
        ...
        canvas.create_window(700, 750, window=button_next)
        ...
        canvas.create_window(830, 750, window=button_exit)
    ...
    try:
        ...
        def calculate_loan():
            try:
                ...
                # Simpan data cicilan ke dalam file JSON
                save_installment_data(username, principal, months, payments, mode)

                # Tampilkan struk kepada user
    ...
    try:
        ...
        def add_duration():
            try:
                ...
                if new_duration not in durations:
                    ...
                    for dur in durations:
                        listbox_durations.insert(tk.END, dur)
                    save_durations(durations)  # Simpan perubahan ke file
        ...
        def update_interest():
            ...
            try:
                ...
                save_bi_rate(bi_rate)  # Simpan BI Rate ke file
